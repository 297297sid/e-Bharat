      ...
      <section className="text-gray-600 body-font">
            <div className="container px-5 py-8 md:py-16 mx-auto">
                ...
                <div className="flex flex-wrap -m-4">
                            ...
                            {product
                                .filter((obj) => obj.title && obj.title.includes(searchkey)|| '')
                                .filter((obj) => obj.category && obj.category.includes(filterType)|| '')
                                .filter((obj) => obj.price && obj.price.toString().includes(filterPrice)|| '')
                                .map((item, index) => {
